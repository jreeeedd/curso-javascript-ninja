...
*/
  ...
  console.log(
    text.replace(/(Manuel Marques de Sousa)/g, "Edson Baptista da Silva")
  );
...
*/
  ...
  console.log(text.replace(/[D-Za-h]/gi, "0"));
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/g, function (match) {
...
*/
  ...
  var dez = "dezembro";
  console.log(
    `O mês de ${mar} é representado pelo número ${getMonthNumber(mar)}`
  );
  console.log(
    `O mês de ${nov} é representado pelo número ${getMonthNumber(nov)}`
  );
  console.log(
    `O mês de ${dez} é representado pelo número ${getMonthNumber(dez)}`
  );
...
*/
  ...
  // o dia e o ano podem ser pegos de forma dinamica, usando apenas umas especies de 'mascara' ao invés do número literal
...
*/
  ...
  // a função que o replace recebe, é a definição. Ou seja, não é a function executada (ou seu retorno), mas sim sua definição.
