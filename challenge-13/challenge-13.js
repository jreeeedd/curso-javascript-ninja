...
*/
  ...
  var brasil = [];
  // outra forma de fazer seria: brasil = sul.concat(sudeste)
...
*/
  ...
  var hasMoreSevenLetters = brasil.every(function (item) {
    return item.length > 7;
  });

  // aqui caberia melhor um ternário
  if (hasMoreSevenLetters) {
...
*/
  ...
  // aqui tb caberia um ternário
  if (hasCeara) {
    console.log("Ceará está incluído!");
  } else {
    console.log("Cerará não foi incluído :(");
  }
